...
add_prog_1(struct svc_req *rqstp, register SVCXPRT *transp)
{
	union {
		int factorial_1_arg;
		calc_input calculate_1_arg;
		int is_prime_1_arg;
		int fibonacci_1_arg;
		int_array max_in_array_1_arg;
	} argument;
	char *result;
	...
	case CALCULATE:
		_xdr_argument = (xdrproc_t) xdr_calc_input;
	...
	case MAX_IN_ARRAY:
		_xdr_argument = (xdrproc_t) xdr_int_array;
		_xdr_result = (xdrproc_t) xdr_int;
		local = (char *(*)(char *, struct svc_req *)) max_in_array_1_svc;
		break;
