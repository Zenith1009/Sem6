...
- Robot picks rock/paper/scissors at random
...
def draw_robot_panel(frame, robot_choice, game_state, countdown_val=None, scale=1.0):
    """
    ...
    cv2.line(panel, (20, 50), (panel_w - 20, 50), (60, 60, 80), 2)
    ...
    if game_state == "countdown":
        ...
        cv2.putText(panel, label, ((panel_w - lw)//2, h - 80), font, 0.7, (150, 150, 200), 2)
        ...
        if robot_choice:
            ...
            cv2.putText(panel, choice_label, ((panel_w - lw)//2, h - 70),
...
while cap.isOpened():
    ...
    # ==============================
    robot_panel = draw_robot_panel(frame, robot_choice, game_state, scale=1.2)
